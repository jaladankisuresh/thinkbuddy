...
var ThinkTransaction = class ThinkTransaction extends EventEmitter {
    ...
    var insertAsync = function(params) {
      ...
      .then(function(uniqueFilter) {
        ...
        .then(function(result) {
          if(!NoSQLTransaction.isEmptyorNull(result)) {
            let error = {
      ...
      return new Promise(function (resolve, reject) {
        ...
        .then(function(cursor) {
          ...
          cursor.each(function(err, doc) {
            ...
            if((self.state !== 'pending') || (NoSQLTransaction.isEmptyorNull(doc.new_val))) {
  ...
  static begin(options) {
    var trans = new NoSQLTransaction(options);
  ...
  commit() {
    ...
    var commitDbOperation = function(params) {
      ...
      .then(function(results) {
        ...
        if(NoSQLTransaction.isEmptyorNull(results)) throw error;
      ...
      switch(params.operation) {
        case 'insert' :
          ...
          .then(function(document) {
            if(NoSQLTransaction.isEmptyorNull(document)) return;
